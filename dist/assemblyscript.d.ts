...
declare module 'assemblyscript/src/util/astutil' {
	...
	export class TypeNodeAnalyzer {
	    ...
	    isVoid(): bool;
	    readonly abiTypeEnum: AbiTypeEnum;
	    isArray(): bool;
...
declare module 'assemblyscript/src/program' {
	...
	import { AbiInfo } from 'assemblyscript/src/abi';
	import { Resolver } from 'assemblyscript/src/resolver';
	import { Flow } from 'assemblyscript/src/flow';
...
declare module 'assemblyscript/src/abi' {
	import { InsertPoint } from 'assemblyscript/src/inserter';
	import { Element, ClassPrototype, Program } from 'assemblyscript/src/program';
	import { Expression } from 'assemblyscript/src/ast'; class StructDef {
	    name: string;
	    fields: Array<Object>;
	    base: string;
