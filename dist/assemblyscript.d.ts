...
declare module "assemblyscript/src/ultrain/collectionutil" {
...
declare module "assemblyscript/src/ultrain/astutil" {
    import { DeclarationStatement, DecoratorKind, Node, ClassDeclaration, DecoratorNode, Range, NamedTypeNode } from "assemblyscript/src/ast";
...
declare module "assemblyscript/src/ultrain/primitiveutil" {
...
declare module "assemblyscript/src/ultrain/inserter" {
    import { ClassDeclaration } from "assemblyscript/src/ast";
    import { Program } from "assemblyscript/src/program";
    import { Range } from "assemblyscript/src/tokenizer";
    import { Indenter } from "assemblyscript/src/ultrain/primitiveutil";
...
declare module "assemblyscript/src/ultrain/abi" {
    import { InsertPoint } from "assemblyscript/src/ultrain/inserter";
    ...
    export class AbiInfo {
         ...
         */
        isActionFnPrototype(element: Element): boolean;
        ...
        */
        private resolveClassDispatcher;
        ...
        private resolve;
        private assemblyDispatch;
    }
    export function getAbiInfo(program: Program): AbiInfo;
    export {};
}
declare module "assemblyscript/src/ultrain/index" {
    export * from "assemblyscript/src/ultrain/abi";
}
declare module "assemblyscript/src/index" {
    ...
    export * from "assemblyscript/src/ultrain/index";
}
