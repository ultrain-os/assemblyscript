(module
 ...
 (func $~lib/array/Array<u64>#__get (; 122 ;) (type $iiI) (param $0 i32) (param $1 i32) (result i64)
  (local $2 i32)
  (set_local $2
   (i32.load
    (get_local $0)
 ...
 (func $~lib/map/Map<u64_u64>#has (; 123 ;) (type $iIi) (param $0 i32) (param $1 i64) (result i32)
  (i32.ne
   (call $~lib/map/Map<u64_u64>#find
    (get_local $0)
    (get_local $1)
 ...
 (func $~lib/map/Map<u64_u64>#get (; 124 ;) (type $iII) (param $0 i32) (param $1 i64) (result i64)
  (local $2 i32)
  (set_local $2
   (call $~lib/map/Map<u64_u64>#find
    (get_local $0)
