(module
        ...
        (block
         (block
          ...
          (if
           ...
           (block $~lib/internal/arraybuffer/storeUnsafeWithOffset<f32_f32>|inlined.0
            (set_local $8
             (i32.add
              (block (result i32)
               (set_local $8
 ...
 (func $~lib/array/Array<f64>#__get (; 92 ;) (type $iiF) (param $0 i32) (param $1 i32) (result f64)
  ...
  (if (result f64)
   ...
   (block $~lib/internal/arraybuffer/loadUnsafe<f64_f64>|inlined.2 (result f64)
    (f64.load offset=8
     (i32.add
      (get_local $2)
      (i32.shl
        ...
        (block
         (block
          ...
          (if
           ...
           (block $~lib/internal/arraybuffer/storeUnsafeWithOffset<u32_u32>|inlined.0
            (set_local $8
             (i32.add
              (block (result i32)
               (set_local $8
        ...
        (block
         (block
          ...
          (if
           ...
           (block $~lib/internal/arraybuffer/storeUnsafeWithOffset<Array<i32>_Array<i32>>|inlined.0
            (set_local $8
             (i32.add
              (block (result i32)
               (set_local $8
        ...
        (block
         (block
          ...
          (if
           ...
           (block $~lib/internal/arraybuffer/storeUnsafeWithOffset<Proxy<i32>_Proxy<i32>>|inlined.0
            (set_local $8
             (i32.add
              (block (result i32)
               (set_local $8
        ...
        (block
         (block
          ...
          (if
           ...
           (block $~lib/internal/arraybuffer/storeUnsafeWithOffset<String_String>|inlined.0
            (set_local $8
             (i32.add
              (block (result i32)
               (set_local $8
