  ...
  block $break|0
   ...
   loop $repeat|0
    ...
    block
     ...
     set_local $4
     block $~lib/internal/arraybuffer/loadUnsafe<i32_i32>|inlined.5 (result i32)
      get_local $1
      get_local $3
      i32.const 2
      i32.shl
 ...
 (func $~lib/array/Array<i32>#indexOf (; 34 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  block $break|0
   loop $continue|0
    ...
    if
     block
      block $~lib/internal/arraybuffer/loadUnsafe<i32_i32>|inlined.7 (result i32)
       get_local $6
       get_local $2
       i32.const 2
       i32.shl
  ...
  block $break|0
   ...
   loop $repeat|0
    ...
    block (result i32)
     i32.const 3
     set_global $~argc
     block $~lib/internal/arraybuffer/loadUnsafe<i32_i32>|inlined.9 (result i32)
      get_local $2
      get_local $3
      i32.const 2
      i32.shl
  ...
  block $break|0
   ...
   loop $repeat|0
    ...
    block (result i32)
     i32.const 3
     set_global $~argc
     block $~lib/internal/arraybuffer/loadUnsafe<i32_i32>|inlined.11 (result i32)
      get_local $2
      get_local $3
      i32.const 2
      i32.shl
