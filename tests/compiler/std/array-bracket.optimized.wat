(module
 ...
 (data (i32.const 120) "\14\00\00\00s\00t\00d\00/\00a\00r\00r\00a\00y\00-\00b\00r\00a\00c\00k\00e\00t\00.\00t\00s")
 ...
 (func $~lib/array/Array<u8>#push (; 8 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $3
 ...
 (func $std/array-bracket/toArray (; 9 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (block $break|0
   (loop $repeat|0
    (br_if $break|0
 ...
 (func $~lib/array/Array<u8>#constructor (; 11 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (if
   (i32.gt_u
    (get_local $1)
 ...
 (func $std/array-bracket/newArray (; 12 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (set_local $2
