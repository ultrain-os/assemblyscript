(module
 ...
 (data (i32.const 5880) "\02\00\00\000\000\00")
 (data (i32.const 5888) "\03\00\00\000\000\000\00")
 (data (i32.const 5904) "\04\00\00\000\000\000\000\00")
 (data (i32.const 5920) "\05\00\00\000\000\000\000\000\00")
 (data (i32.const 5936) "\06\00\00\000\000\000\000\000\000\00")
 (data (i32.const 5952) "\07\00\00\000\000\000\000\000\000\000\00")
 (data (i32.const 5976) "\08\00\00\000\000\000\000\000\000\000\000\00")
 (data (i32.const 6000) "$\00\00\00\00\00\00\00\00\01\00\00\e0\01\00\00\f8\16\00\00\00\17\00\00\10\17\00\00 \17\00\000\17\00\00@\17\00\00X\17\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 6064) "p\17\00\00\t\00\00\00")
 (data (i32.const 6072) "\05\00\00\001\000\000\000\000\00")
 (data (i32.const 6088) "\06\00\00\001\000\000\000\00.\000\00")
 (data (i32.const 6104) "\06\00\00\001\000\000\00.\000\000\00")
 (data (i32.const 6120) "\06\00\00\000\00.\000\000\000\000\00")
 (data (i32.const 6136) "\06\00\00\000\00.\000\000\000\001\00")
 (data (i32.const 6152) "\07\00\00\001\001\00.\001\001\001\001\00")
 (data (i32.const 6176) "\0b\00\00\001\00.\000\000\000\000\00 \00U\00G\00A\00S\00")
 (data (i32.const 6208) "\0e\00\00\001\00.\000\000\000\000\000\000\000\000\00 \00A\00B\00C\00")
 (table $0 1 anyfunc)
 ...
 (global $std/string/CHAR_A i32 (i32.const 65))
 (global $std/string/CHAR_Z i32 (i32.const 90))
 (global $HEAP_BASE i32 (i32.const 6240))
 ...
 (func $~lib/internal/number/utoa32_lut (; 50 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
   ...
   loop $continue|0
    ...
    if
     block
      ...
      i32.rem_u
      set_local $7
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.0 (result i64)
       i32.const 0
       set_local $8
       get_local $3
       get_local $6
      ...
      set_local $9
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.1 (result i64)
       i32.const 0
       set_local $8
       get_local $3
       get_local $7
  ...
  if
   ...
   i32.sub
   set_local $2
   block $~lib/internal/arraybuffer/LOAD<u32_u32>|inlined.0 (result i32)
    i32.const 0
    set_local $5
    get_local $3
    get_local $6
   ...
   loop $continue|0
    ...
    if
     block
      ...
      i32.rem_u
      set_local $11
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.2 (result i64)
       i32.const 0
       set_local $12
       get_local $3
       get_local $10
      ...
      set_local $13
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.3 (result i64)
       i32.const 0
       set_local $12
       get_local $3
       get_local $11
      ...
      i64.or
      i64.store offset=4
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.4 (result i64)
       i32.const 0
       set_local $12
       get_local $3
       get_local $8
      ...
      set_local $13
      block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.5 (result i64)
       i32.const 0
       set_local $12
       get_local $3
       get_local $9
    ...
    if
     block
      ...
      if
       ...
       block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.6 (result i64)
        i32.const 0
        set_local $18
        get_local $16
        get_local $14
    ...
    if
     block
      ...
      if
       ...
       set_global $~lib/internal/number/_K
       get_local $10
       block $~lib/internal/arraybuffer/LOAD<u32_u64>|inlined.7 (result i64)
        i32.const 0
        get_local $14
        i32.sub
        set_local $17
 ...
 (func $~lib/internal/number/dtoa_core (; 61 ;) (type $iFi) (param $0 i32) (param $1 f64) (result i32)
  ...
  block $~lib/internal/number/grisu2|inlined.0 (result i32)
   ...
   block
    ...
    i32.load
    set_local $13
    block $~lib/internal/arraybuffer/LOAD<u64_u64>|inlined.0 (result i64)
     i32.const 0
     set_local $14
     get_local $12
     get_local $8
    ...
    block $~lib/internal/arraybuffer/LOAD<i16_i32>|inlined.0 (result i32)
     i32.const 0
     set_local $14
     get_local $13
     get_local $8
 ...
 (func $~lib/math/NativeMath.scalbn (; 64 ;) (type $FiF) (param $0 f64) (param $1 i32) (result f64)
  (local $2 f64)
  (local $3 i32)
  (local $4 i32)
  get_local $0
 ...
 (func $~lib/math/NativeMath.pow (; 65 ;) (type $FFF) (param $0 f64) (param $1 f64) (result f64)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $std/string/toAmountStr (; 66 ;) (type $Iii) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i64)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $std/string/formatAmount (; 67 ;) (type $Iii) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i64)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $std/string/toString (; 68 ;) (type $IIi) (param $0 i64) (param $1 i64) (result i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
