(module
 ...
 (data (i32.const 5360) "\02\00\00\000\000")
 (data (i32.const 5368) "\03\00\00\000\000\000")
 (data (i32.const 5384) "\04\00\00\000\000\000\000")
 (data (i32.const 5400) "\05\00\00\000\000\000\000\000")
 (data (i32.const 5416) "\06\00\00\000\000\000\000\000\000")
 (data (i32.const 5432) "\07\00\00\000\000\000\000\000\000\000")
 (data (i32.const 5456) "\08\00\00\000\000\000\000\000\000\000\000")
 (data (i32.const 5480) "$\00\00\00\00\00\00\00p\00\00\00\e0\01\00\00\f0\14\00\00\f8\14\00\00\08\15\00\00\18\15\00\00(\15\00\008\15\00\00P\15")
 (data (i32.const 5544) "h\15\00\00\t")
 (data (i32.const 5552) "\05\00\00\001\000\000\000\000")
 (data (i32.const 5568) "\06\00\00\001\000\000\000\00.\000")
 (data (i32.const 5584) "\06\00\00\001\000\000\00.\000\000")
 (data (i32.const 5600) "\06\00\00\000\00.\000\000\000\000")
 (data (i32.const 5616) "\06\00\00\000\00.\000\000\000\001")
 (data (i32.const 5632) "\07\00\00\001\001\00.\001\001\001\001")
 (data (i32.const 5656) "\0b\00\00\001\00.\000\000\000\000\00 \00U\00G\00A\00S")
 (data (i32.const 5688) "\0e\00\00\001\00.\000\000\000\000\000\000\000\000\00 \00A\00B\00C")
 (table $0 1 funcref)
 ...
 (func $~lib/math/NativeMath.scalbn (; 53 ;) (type $FUNCSIG$ddi) (param $0 f64) (param $1 i32) (result f64)
  local.get $1
  i32.const 1023
  i32.gt_s
  if (result f64)
 ...
 (func $std/string/toAmountStr (; 55 ;) (type $FUNCSIG$iji) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  local.get $0
 ...
 (func $std/string/formatAmount (; 56 ;) (type $FUNCSIG$iji) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  local.get $0
 ...
 (func $std/string/toString (; 57 ;) (type $FUNCSIG$ijj) (param $0 i64) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
