(module
 ...
 (data (i32.const 5880) "\02\00\00\000\000")
 (data (i32.const 5888) "\03\00\00\000\000\000")
 (data (i32.const 5904) "\04\00\00\000\000\000\000")
 (data (i32.const 5920) "\05\00\00\000\000\000\000\000")
 (data (i32.const 5936) "\06\00\00\000\000\000\000\000\000")
 (data (i32.const 5952) "\07\00\00\000\000\000\000\000\000\000")
 (data (i32.const 5976) "\08\00\00\000\000\000\000\000\000\000\000")
 (data (i32.const 6000) "$")
 (data (i32.const 6009) "\01\00\00\e0\01\00\00\f8\16\00\00\00\17\00\00\10\17\00\00 \17\00\000\17\00\00@\17\00\00X\17")
 (data (i32.const 6064) "p\17\00\00\t")
 (data (i32.const 6072) "\05\00\00\001\000\000\000\000")
 (data (i32.const 6088) "\06\00\00\001\000\000\000\00.\000")
 (data (i32.const 6104) "\06\00\00\001\000\000\00.\000\000")
 (data (i32.const 6120) "\06\00\00\000\00.\000\000\000\000")
 (data (i32.const 6136) "\06\00\00\000\00.\000\000\000\001")
 (data (i32.const 6152) "\07\00\00\001\001\00.\001\001\001\001")
 (data (i32.const 6176) "\0b\00\00\001\00.\000\000\000\000\00 \00U\00G\00A\00S")
 (data (i32.const 6208) "\0e\00\00\001\00.\000\000\000\000\000\000\000\000\00 \00A\00B\00C")
 (table $0 1 anyfunc)
 ...
 (func $~lib/math/NativeMath.scalbn (; 55 ;) (type $FiF) (param $0 f64) (param $1 i32) (result f64)
  get_local $1
  i32.const 1023
  i32.gt_s
  if (result f64)
 ...
 (func $~lib/math/NativeMath.pow (; 56 ;) (type $FUNCSIG$dd) (param $0 f64) (result f64)
  (local $1 i32)
  (local $2 f64)
  (local $3 f64)
  (local $4 i32)
 ...
 (func $std/string/toAmountStr (; 57 ;) (type $Iii) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  get_local $0
 ...
 (func $std/string/formatAmount (; 58 ;) (type $Iii) (param $0 i64) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  get_local $0
 ...
 (func $std/string/toString (; 59 ;) (type $IIi) (param $0 i64) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
